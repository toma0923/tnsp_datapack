...
execute if score $count kt.util matches 1.. if block ~ ~ ~ #tnsp:transparent positioned ^ ^-2 ^ unless entity @e[tag=!kt.me,type=!armor_stand,type=!block_display,dy=4] positioned ^ ^2 ^1 run return run tag @s remove kt.me
