...
execute as @n[tag=kt.baby_wall,type=item_display] at @s run summon item_display ~ ~-0.5 ~ {Tags:["kt.wall","kt.baby_wall","kt.wall_for_ride"],Passengers:[{id:"minecraft:shulker",Silent:1b,Health:5f,DeathLootTable:"minecraft:empty",NoAI:1b,AttachFace:0b,Tags:["kt.baby_wall","kt.wall"],active_effects:[{id:"minecraft:invisibility",amplifier:1,duration:99999999,show_particles:0b}]}]}
