...
execute anchored eyes run summon tadpole ^ ^ ^1 {active_effects:[{id:invisibility,duration:9999999,show_particles:false},{id:weakness,duration:99999999,show_particles:false}],Invulnerable:1b,Silent:1b,DeathLootTable:"minecraft:empty",Tags:["kt.tadpole_under_cannon","kt.baby_tadpole_under_cannon"]}
ride @n[tag=kt.baby_stone_cannon] mount @n[tag=kt.baby_tadpole_under_cannon]
...
tag @e remove kt.baby_tadpole_under_cannon