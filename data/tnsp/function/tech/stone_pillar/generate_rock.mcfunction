...
scoreboard players set @n[tag=kt.baby_rock_armor_stand] kt.timer 100
...
summon item_display ~ ~ ~ {Tags:["kt.rock","kt.baby_rock"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[2.5f,1.5f,1.5f],scale:[1f,1f,1f]}}
