...
execute if score @s kt.gold matches ..199 run return run item replace entity @s container.20 with creeper_spawn_egg[custom_name={"bold":true,"color":"gold","italic":false,"text":"戦闘系オーグメントを引く"},lore=[{"color":"gold","italic":false,"text":"200G"}],custom_data={"battle_augment":1b,"shop":1b}] 1
...
scoreboard players remove @s kt.gold 200
